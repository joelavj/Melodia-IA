...
- **src/** : Contient le code source de l'application.
  ...
  - **views/** : Contiendra les composants de l'interface utilisateur.
...
- **tests/** : Contiendra les tests unitaires pour les modèles, services et contrôleurs.
...
La base MySQL doit être créée avec `docs/melodia_ai.sql` avant d'utiliser les
repositories et les services qui accèdent à la bibliothèque.
