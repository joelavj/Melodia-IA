...
CREATE DATABASE IF NOT EXISTS `melodia_ia` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `melodia_ia`;
...
CREATE TABLE IF NOT EXISTS `album` (
  ...
  `pochette` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Listage de la structure de table melodia_ia. appartenir
CREATE TABLE IF NOT EXISTS `appartenir` (
  `id_album` int NOT NULL,
  `id_morceau` int NOT NULL,
  PRIMARY KEY (`id_album`,`id_morceau`),
  KEY `FK__morceau1` (`id_morceau`),
  CONSTRAINT `FK__album1` FOREIGN KEY (`id_album`) REFERENCES `album` (`id_album`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK__morceau1` FOREIGN KEY (`id_morceau`) REFERENCES `morceau` (`id_morceau`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `artiste` (
  ...
  `nom_scene` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_artiste`),
  UNIQUE KEY `nom_scene` (`nom_scene`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Les données exportées n'étaient pas sélectionnées.

-- Listage de la structure de table melodia_ia. contenir
CREATE TABLE IF NOT EXISTS `contenir` (
  `id_morceau` int NOT NULL,
  `id_playlist` int NOT NULL,
  `num_ordre` int NOT NULL,
  PRIMARY KEY (`id_morceau`,`id_playlist`),
  KEY `FK__playlist_1` (`id_playlist`),
  CONSTRAINT `FK__morceau_1` FOREIGN KEY (`id_morceau`) REFERENCES `morceau` (`id_morceau`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK__playlist_1` FOREIGN KEY (`id_playlist`) REFERENCES `playlist` (`id_playlist`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Les données exportées n'étaient pas sélectionnées.

-- Listage de la structure de table melodia_ia. interpreter
CREATE TABLE IF NOT EXISTS `interpreter` (
  `id_artiste` int NOT NULL,
  `id_morceau` int NOT NULL,
  PRIMARY KEY (`id_artiste`,`id_morceau`),
  KEY `FK__morceau2` (`id_morceau`),
  CONSTRAINT `FK__artiste2` FOREIGN KEY (`id_artiste`) REFERENCES `artiste` (`id_artiste`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK__morceau2` FOREIGN KEY (`id_morceau`) REFERENCES `morceau` (`id_morceau`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `morceau` (
  ...
  `titre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `chemin` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `genre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `favori` tinyint(1) NOT NULL DEFAULT '0',
  `parole` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  CONSTRAINT `FK_morceau_album` FOREIGN KEY (`id_album`) REFERENCES `album` (`id_album`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Listage de la structure de table melodia_ia. produit
...
CREATE TABLE IF NOT EXISTS `repertoire` (
  ...
  `chemin` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
